      ...
      <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
        ...
        <div className="col-span-4 sm:col-span-9">
          <form onSubmit={handleSubmit}>
            <div className="bg-gray-900 shadow rounded-lg p-6 flex">
              <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                <label className="block uppercase tracking-wide text-yellow-400 text-xs font-bold mb-2" htmlFor="grid-first-name">
                  Username
                </label>
                <input type="text" placeholder="Username"
                  ...
                  className="appearance-none block w-full bg-black text-yellow-400 border border-yellow-400 rounded py-3 px-4 mb-3" id="grid-first-name" />
              </div>
              <div className="md:w-1/2 px-3">
                <label className="block uppercase tracking-wide text-yellow-400 text-xs font-bold mb-2" htmlFor="grid-last-name">
                  Mobile No.
                </label>
                <input type="number" placeholder="+91 "
                  ...
                  onChange={handleChange}
                  className="appearance-none block w-full bg-black text-yellow-400 border border-yellow-400 rounded py-3 px-4" id="grid-last-name" />
              </div>
            </div>
            ...
            <div className="bg-gray-900 shadow rounded-lg p-6 mt-3 mb-4">
              ...
              <div className="flex justify-between">
                <label htmlFor="fileInput" className="mt-5 mx-20 text-yellow-400 text-md font-bold cursor-pointer">
                  Edit Your Profile
                  <input
                    ref={fileInputRef}
                    type="file"
                ...
                <div>
                  <button type='submit' className='bg-yellow-500 hover:bg-yellow-600 text-black py-2 px-4 rounded'>Save Changes</button>
                </div>
              </div>
            </div>
          </form>
