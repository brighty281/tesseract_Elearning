  ...
  <div className="container mx-auto py-8">
    <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <div className="col-span-4 sm:col-span-9">
        <div className="bg-yellow-500 shadow rounded-lg p-6">
          <h2 className="text-lg font-bold mb-4 text-gray-800">About Me</h2>
          <p className="text-gray-800 mb-5 mx-20">
            {formData.about ? formData.about : 'Not Set Yet'}
          </p>

          <h2 className="text-lg font-bold mb-4  text-gray-800">Phone Number</h2>
          <p className="text-gray-800 mx-20 mb-5">
            {formData.phone ? formData.phone : 'Not Set Yet'}
          </p>

          <h3 className="font-semibold text-center mt-3 -mb-2  text-gray-800">Find me on</h3>
